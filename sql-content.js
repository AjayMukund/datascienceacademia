...
L['sql-w1-quiz'] = { duration_mins: 10, sections: [
  { type:'text', body:`<h2>Week 1 Quiz — SQL Foundations</h2><p>Test your knowledge of relational databases, SELECT, WHERE, ORDER BY, LIMIT, CASE WHEN, and NULL handling.</p>` }
]};

L['sql-w2-quiz'] = { duration_mins: 10, sections: [
  { type:'text', body:`<h2>Week 2 Quiz — Aggregation &amp; Grouping</h2><p>Test your knowledge of aggregate functions (COUNT, SUM, AVG, MIN, MAX), GROUP BY, HAVING, DISTINCT, type conversion, and KPI queries.</p>` }
]};

L['sql-w3-quiz'] = { duration_mins: 10, sections: [
  { type:'text', body:`<h2>Week 3 Quiz — JOINs &amp; Relationships</h2><p>Test your knowledge of primary and foreign keys, INNER JOIN, LEFT/RIGHT/FULL OUTER JOIN, self-joins, cross joins, and multi-table query patterns.</p>` }
]};

L['sql-w4-quiz'] = { duration_mins: 10, sections: [
  { type:'text', body:`<h2>Week 4 Quiz — Subqueries &amp; Window Functions</h2><p>Test your knowledge of scalar subqueries, correlated subqueries, CTEs, ROW_NUMBER, RANK, DENSE_RANK, LAG, LEAD, and running totals.</p>` }
]};

L['sql-w5-quiz'] = { duration_mins: 10, sections: [
  { type:'text', body:`<h2>Week 5 Quiz — Optimisation &amp; Python Integration</h2><p>Test your knowledge of indexes, B-tree internals, EXPLAIN ANALYZE, query plan reading, views, materialised views, and SQL from Python with psycopg2 and pandas.</p>` }
]};
